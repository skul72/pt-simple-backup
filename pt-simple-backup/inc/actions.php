...
add_action('admin_enqueue_scripts', function($hook){
    ...
    wp_enqueue_style('ptsb-admin', PTSB_ASSETS_URL . 'admin.css', [], '1.0.0');

    wp_enqueue_script('ptsb-admin', PTSB_ASSETS_URL . 'admin.js', ['jquery'], '1.0.0', true);
    wp_localize_script('ptsb-admin', 'ptsbAdminData', [
