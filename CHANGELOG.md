...
## [1.2.13] - 2025-11-18
- Força o uso do binário PHP na chamada de restauração para dispensar permissões de execução no script embarcado.
- Detecta o caminho do PHP CLI quando disponível, mantendo fallback para `php` no `PATH`.
